...
export const getErrorMessage = (key: string): string => {
  const errors: ErrorLookup = {
    ...
    "error.containerNumbers.plane.string.empty": "commonAddTransportationDetailsPlaneContainerNumberLabelError",
    "error.containerNumbers.plane.string.pattern.base":
      "commonAddTransportationDetailsPlaneContainerOnlyNumLettersError",
    "error.containerNumbers.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.0.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.1.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.2.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.3.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.4.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.5.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.6.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.7.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.8.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.9.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.0.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.1.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.2.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.3.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.4.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.5.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.6.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.7.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.8.string.max": "ccContainerIdentificationNumberMaxLength",
    "error.containerNumbers.plane.9.string.max": "ccContainerIdentificationNumberMaxLength",
    ...
    "error.containerNumbers.0.any.required": "ccContainerVesselContainerNumberLabelError",
    ...
    "error.containerNumbers.1.any.required": "ccContainerVesselContainerNumberLabelError",
    ...
    "error.containerNumbers.plane.array.unique": "ccContainerNumberDuplicateError",
    ...
    errorTruckDepartureDateTodayMax: "sdTransportDepatureDateMaxError",
    errorPlaneDepartureDateTodayMax: "sdTransportDepatureDateMaxError",
    errorTrainDepartureDateTodayMax: "sdTransportDepatureDateMaxError",
    errorContainerVesselDepartureDateTodayMax: "sdTransportDepatureDateMaxError",
