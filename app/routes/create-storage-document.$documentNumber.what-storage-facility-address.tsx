...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const actionUri = `/create-storage-document/${documentNumber}/what-storage-facility-address`;
  if (!isEmpty(postcode)) {
...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  if (buttonClicked === "continueManualAddress") {
    ...
    await updateStorageDocumentFacility(
      bearerToken,
      documentNumber,
      `/create-storage-document/${documentNumber}/what-storage-facility-address`,
      false,
      undefined,
      {
        ...formData,
