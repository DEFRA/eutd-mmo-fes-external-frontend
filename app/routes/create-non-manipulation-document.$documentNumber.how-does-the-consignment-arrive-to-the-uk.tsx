...
export const action: ActionFunction = async ({ request, params }): Promise<Response | ErrorResponse> => {
  ...
  return await HowDoesTheConsignmentArriveToTheUkAction({
    ...
    documentNumber,
    vehicle,
    currentUri: route("/create-non-manipulation-document/:documentNumber/how-does-the-consignment-arrive-to-the-uk", {
      documentNumber,
    }),
    saveAsDraftUrl: route("/create-non-manipulation-document/non-manipulation-documents"),
    completedUrl: `/create-non-manipulation-document/${documentNumber}/${arrivalTransportForwardUri(vehicle)}`,
  });
};
...
const HowDoesTheConsignmentArriveAToTheUk = () => (
  <HowDoesTransportTakesPlaceInTheUkForm
    ...
    backUrl="/create-non-manipulation-document/:documentNumber/you-have-added-a-product"
