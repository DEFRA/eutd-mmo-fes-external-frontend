...
export const action: ActionFunction = async ({ request, params }): Promise<Response> => {
  ...
  if (isEdit) {
    ...
    return redirect(`/create-non-manipulation-document/${documentNumber}/add-product-to-this-consignment/${editIndex}`);
  }
...
const DepartureProductSummary = () => {
  ...
  return (
    <Main backUrl={`/create-non-manipulation-document/${documentNumber}/${backUri(transport, "storageNotes")}`}>
