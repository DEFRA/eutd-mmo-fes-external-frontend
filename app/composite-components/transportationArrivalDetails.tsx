...
const getCommonArrivalInputProps = (fieldName: string, errors: IErrorsTransformed, t: any) => ({
  hint: {
    id: `hint-${fieldName}`,
    position: "above" as const,
    text: t(`addTransportationArrivalDetails${fieldName.charAt(0).toUpperCase() + fieldName.slice(1)}Hint`),
    ...
    <>
      ...
      {vehicle === "train" && (
        <FormInput
          ...
          {...getCommonArrivalInputProps("railwayBillNumber", errors, t)}
        />
      )}
      ...
      {vehicle === "truck" && (
        <>
          ...
          <FormInput
            ...
            {...getCommonArrivalInputProps("registrationNumber", errors, t)}
          />
        </>
      )}
      {vehicle === "plane" && (
        <>
          <FormInput
            ...
            {...getCommonArrivalInputProps("airwayBillNumber", errors, t)}
          />
          <FormInput
            containerClassName="govuk-form-group govuk-!-width-one-half"
  ...
  return (
    <fieldset className="govuk-fieldset">
      ...
      <FormInput
        ...
        inputProps={{
          defaultValue: placeOfUnloading ?? "",
          id: "placeOfUnloading",
          "aria-describedby": "hint-placeOfUnloading",
        }}
        hint={{
          id: "hint-placeOfUnloading",
          position: "above",
          text: t(
            vehicle === "containerVessel"
              ? "addTransportationArrivalDetailsVesselPlaceOfUnloadingHint"
              : "addTransportationArrivalDetailsTruckPlaceOfUnloadingHint",
            { vehicle: t(vehicle).toLowerCase() }
          ),
          className: "govuk-hint govuk-!-margin-bottom-0",
        }}
        errorProps={{ className: getErrorMessageClassName(!isEmpty(errors?.placeOfUnloading)) }}
