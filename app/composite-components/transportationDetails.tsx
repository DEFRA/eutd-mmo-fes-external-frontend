...
const ContainerIdentificationNumberField = ({
  ...
  <FormInput
    ...
    label={t(labelKey ?? "addTransportationDetailsContainerIdentificationNumber")}
    ...
    hint={{
      ...
      position: "above",
      text: t(hintKey ?? "addTransportationDetailsContainerIdentificationNumberHintTruckTrain"),
