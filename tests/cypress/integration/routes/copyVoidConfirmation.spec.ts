...
const pageUrl = "create-catch-certificate/GBR-2022-CC-F71D98A30/copy-void-confirmation";

function copyvoidpage(testParams) {
  cy.visit("create-catch-certificate/GBR-2022-CC-F71D98A30/copy-this-catch-certificate", { qs: { ...testParams } });
  ...
  it("should redirect to copy-void-confirmation page when voidDocumentConfirm option is selected", () => {
    ...
    cy.get("form").should(($form) => {
      ...
      expect(labels).to.deep.eq([
        "Yes, create a copy of the catch certificate then void the original",
