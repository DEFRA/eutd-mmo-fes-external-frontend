...
const psPageUrl = "create-processing-statement/GBR-2022-PS-F71D98A30/what-processing-plant-address";

describe("PS: What processing plant address page", () => {
  beforeEach(() => {
...
describe("PS: On Selected Address", () => {
  ...
  it("should display error if no postcode has been entered", () => {
    const testParams: ITestParams = {
      testCaseId: TestCaseId.PSExporterSelectAddressPostcodeEmptyError,
    };
  ...
  it("should display error if the entered postcode is invalid", () => {
    const testParams: ITestParams = {
      testCaseId: TestCaseId.PSExporterSelectAddressPostcodeInvalidError,
    };
  ...
  it("should go back to add-processing-plant-address if cancelling postcode search", () => {
    const testParams: ITestParams = {
      testCaseId: TestCaseId.PSExporterSelectAddress,
    };
